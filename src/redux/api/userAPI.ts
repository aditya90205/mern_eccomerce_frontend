...
export const {useLoginMutation, useAllUsersQuery, useDeleteUserMutation} = userAPI;  // useLoginMutation is a hook that can be used in components to make a login request